...
- [Done] Send your team lead the link to your web app 
- [Done] Show them that it has been added to your portfolio
- [Done] If you don't have a portfolio, use this project time to create a portfolio, and deploy it with Vercel ([here](https://github.com/LambdaSchool/portfolio-website) is a guide for this)
- [Done] Once you have finished, your TL will count the project as completed
